...
// Pixel class driving each individual pixel's grow/shimmer/shrink animation
class Pixel {
  width: number
  height: number
...
// Web component that owns the canvas and drives the pixel grid animation
...
// React wrapper around the web component
