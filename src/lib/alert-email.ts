...
interface RecoveredParams {
  productName: string;
  url: string;
  productId: string;
}

export function recoveredEmailHtml({ productName, url, productId }: RecoveredParams) {
  return `
  <div style="font-family: -apple-system, Segoe UI, Roboto, sans-serif; background: #f4f4f5; padding: 32px 16px;">
    <div style="max-width: 480px; margin: 0 auto; background: #ffffff; border-radius: 12px; overflow: hidden; border: 1px solid #e5e7eb;">
      <div style="background: #18181b; padding: 20px 24px;">
      ...
      <div style="padding: 28px 24px;">
        <span style="display: inline-block; background: #22c55e; color: #ffffff; font-size: 12px; font-weight: 700; letter-spacing: 0.5px; padding: 4px 10px; border-radius: 999px; margin-bottom: 16px;">
          BACK UP
        </span>
        ...
        <p style="margin: 0 0 24px; font-size: 14px; color: #52525b;">
          This site is responding normally again.
        </p>
